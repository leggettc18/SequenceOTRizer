...
class Sequence : public OTRizer::Resource {
    ...
    public:
        ...
        */
         ...
         * 
         * Should be set to two for custom sequences representing the MEDIUM_CART enum.
         */
        uint8_t medium;
        /**
         * @brief the cache policy to tell the game how to cache the sequence.
         * 
         * This should be 2 (`CACHE_TEMPORARY`) for BGM sequences and 1 (`CACHE_PERSISTENT`) for Fanfare Sequences.
         */
        uint8_t cachePolicy;
        /**
         ...
         * 
         * See [the instrument sets here](https://sites.google.com/site/deathbasketslair/zelda/ocarina-of-time/instrument-lists#TOC-Percussion-maps)
